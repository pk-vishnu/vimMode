...
<img width="961" height="248" alt="image" src="https://github.com/user-attachments/assets/cadceba3-24d2-4597-b896-accc9d5f642e" />

- Cursor movement (`h` `j` `k` `l`, `w` `b`, `gg` `G`, `0` `$`)
- Word + line actions (`iw` `aw`, `dd` `yy` `cc` `o`)
